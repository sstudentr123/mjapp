    ...
    <div class="BaAllProducts BaAllProductsShow" id="addProducts">
        <form id="addProductsForm" autocomplete="off">
            ...
            <div class="bottom">
                <div class="row filerow">
                    ...
                    <div class="col-10 filebox">
                        <label for="addCover0" class="coverLabel">
                            <input id="addCover0" type="file" onchange="preview(this,400,400);" data-validation-engine="validate[required]">
                        </label>
                ...
                <div class="row">
                    <label class="col-2" for="addContent">標題</label>
                    <div class="col-10">
                        <input class="form-control" id="addContent" type="text" name="Content" data-validation-engine="validate[required]">
                    </div>
                </div>
                <div class="row">
