...
function soundBg() {
    // var url = "./audio/0"+random({t:5,i:1})+".mp3",
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(25.059167, 121.634258), // New York
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(25.059167, 121.634258),
        map: map,
        title: ''
    });
}
function init2() {
    ...
    var mapOptions = {
        ...
        // The latitude and longitude to center the map (always required)
        center: new google.maps.LatLng(22.996085, 120.174426), // New York
    ...
    // Let's also add a marker while we're at it
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(22.996085, 120.174426),
        map: map,
        title: ''
    });
}
...
window.onload=function() {
    requestServerCall({
    	// url:"./php/transfer.php?act=dream&callback=mycallback",
        url:"./php/transfer.php",
        data: {
            act: "dream"
        },
        ...
        var items = document.querySelectorAll('.indexCase .items')[0];
        var ob='';
        var url ='';
        for(var i=0; i<product.length;i++){
            if(product[i].Url=='#'){
                url = 'javascript:caseLightbox('+product[i].id+')';
            }else{
                url = product[i].Url;
            }
            ob +='<div class ="scrollAnimation scrollAnimation_delay'+(i%3+1)+'">\
                <a href="'+url+'"  target="_blank">\
                    <div class="img">\
                        <img src="'+product[i].Cover0+'" alt="">\
                    </div>\
                    <div class="text">\
                        <h5>'+product[i].Pname+'</h5>\
                    </div>\
                </a>\
            </div>';
        }
        ...
        var items = document.querySelectorAll('.indexCooperation .items')[0];
        var ob='';
        for(var i=0; i<cooperation.length;i++){
            ob +='<li class="scrollAnimation scrollAnimation_delay'+cooperation[i]+'">'+
                '<div class="img"><img src="'+cooperation[i].Cover0+'" alt=""></div>'+
                '<div class="line"></div>'+
                '<p>'+cooperation[i].Content+'</p></li>';
        }
        items.innerHTML = ob;

        //cooperation_title
        var cooperation_title = data.cooperation_title;
        var items = document.querySelectorAll('.indexCooperation .title')[0];
        var ob='';
        for(var i=0; i<cooperation_title.length;i++){
            ob +='<h1>'+cooperation_title[i].title+'</h1><h3>'+cooperation_title[i].subtitle+'</h3><div class="line"></div>';
        }
        items.innerHTML = ob;

        //team    
        var team = data.team;
        var items = document.querySelectorAll('.indexTeam .items')[0];
        var ob='';
        for(var i=0; i<team.length;i++){
            ob +='<div class="item scrollAnimation scrollAnimation_delay'+team[i]+' hoverParallax">\
                    <div class="itemout">\
                        <div class="boxs">\
                            <div class="box"></div>\
                            <div class="box"></div>\
                        ...
                        <div class="itemTitle"> \
                            <h4>'+team[i].title+'<span>'+team[i].subtitle+'</span></h4>\
                        </div>\
                        <div class="img"><img src="'+team[i].Cover0+'" alt=""></div>\
                        <div class="text">\
                            <p>'+team[i].Content+'</p>\
                        </div>\
                    </div>\
